...
if __name__ == '__main__':
    ...
    for a_iter in range(args.iters):
        ...
        if not os.path.exists(os.path.join('../logs/cifar_fedavg', args.mode)):
            os.makedirs(os.path.join('../logs/cifar_fedavg', args.mode))
    ...
    # save record
    np.savetxt(os.path.join('../logs/cifar_fedavg', args.mode, 'client' + str(args.clientnum) +
